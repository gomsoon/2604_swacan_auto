...
def test_playwright_admin_page(page: Page, live_server) -> None:
    ...
    expect(page.locator("#alert-rule-editor-status")).to_contain_text("Publish 준비됨")
    ...
    expect(page.locator("#alert-rule-preview-panel")).to_contain_text("winner 현재 입력 rule")
    expect(page.locator("#alert-rule-preview-panel")).to_contain_text("winner / suppressed 설명은 competing published rule")
    ...
    page.locator("#alert-rule-critical-clause1-comparison").select_option("gte")
    page.locator("#alert-rule-critical-clause1-value").fill("90")
    page.locator("#alert-rule-critical-clause2-comparison").select_option("gte")
    page.locator("#alert-rule-critical-clause2-value").fill("95")
    page.locator("#alert-rule-metric-key").fill("cpu_usage")
    page.get_by_role("button", name="Preview").click()
    ...
    expect(page.locator("#alert-rule-preview-panel")).to_contain_text("blocked draft save")
    expect(page.locator("#alert-rule-preview-panel")).to_contain_text("Publish readiness: draft를 먼저 저장한 뒤 publish 가능합니다.")
    page.locator("#alert-rule-metric-key").fill("fd_count")
    page.locator("#alert-rule-critical-clause1-comparison").select_option("gte")
    page.locator("#alert-rule-critical-clause1-value").fill("70")
    page.locator("#alert-rule-critical-clause2-comparison").select_option("gte")
    page.locator("#alert-rule-critical-clause2-value").fill("90")
    page.get_by_role("button", name="Preview").click()
    expect(page.locator("#alert-rule-preview-panel")).to_contain_text("조건 해석")
    expect(page.locator("#alert-rule-preview-panel")).to_contain_text("Severity 관계")
    expect(page.locator("#alert-rule-preview-panel")).to_contain_text("critical_condition must be a subset of warning_condition.")
    page.locator("#alert-rule-critical-clause1-comparison").select_option("gte")
    page.locator("#alert-rule-critical-clause1-value").fill("90")
    page.locator("#alert-rule-critical-clause2-comparison").select_option("gte")
    page.locator("#alert-rule-critical-clause2-value").fill("95")
    ...
    expect(page.locator("#alert-rule-warning-clause1-value")).to_have_value("20")
    expect(page.locator("#alert-rule-warning-clause2-value")).to_have_value("80")
    expect(page.locator("#alert-rule-critical-clause1-value")).to_have_value("90")
    expect(page.locator("#alert-rule-critical-clause2-value")).to_have_value("95")
    expect(page.locator("#alert-rule-editor-status")).to_contain_text("compound draft")
    expect(page.locator("#alert-rule-editor-status")).to_contain_text("Publish 준비됨")
    expect(page.locator("#alert-rule-editor-status")).to_contain_text("현재 draft는 publish 가능합니다.")
    expect(page.locator("#publish-current-alert-rule-button")).to_be_visible()
    expect(page.locator("#publish-current-alert-rule-button")).to_be_enabled()
    page.locator("#alert-rule-warning-clause2-value").fill("85")
    expect(page.locator("#alert-rule-editor-status")).to_contain_text("미저장 변경")
    expect(page.locator("#alert-rule-editor-status")).to_contain_text("먼저 저장하세요")
    expect(page.locator("#publish-current-alert-rule-button")).to_be_disabled()
    page.locator("#save-alert-rule-button").click()
    expect(page.locator("#alert-rule-preview-condition-mode")).to_have_value("compound")
    expect(page.locator("#alert-rule-warning-clause2-value")).to_have_value("85")
    expect(page.locator("#publish-current-alert-rule-button")).to_be_enabled()

    createdRule = page.locator(".admin-item", has_text="threshold.process.fd_count.file-descriptor-high").first
    expect(createdRule).to_contain_text("ready")
    ...
    expect(page.locator("#alert-rule-preview-panel")).to_contain_text("warning condition: lte 20 OR gte 85")
    expect(page.locator("#alert-rule-preview-panel")).to_contain_text("ready")
    page.locator("#publish-current-alert-rule-button").click()
