...
def test_playwright_admin_page(page: Page, live_server) -> None:
    ...
    page.locator('#metamodel-workspace-canvas [data-workspace-kind="semantic_type"]').filter(has_text="Worker Pool Inspector").dispatch_event("pointerover", {"bubbles": True})
    expect(page.locator("#metamodel-workspace-mode-status")).to_contain_text("Worker Pool Inspector")
    expect(page.locator("#metamodel-workspace-mode-status")).to_contain_text("기존 rule 편집")
    ...
    page.get_by_role("button", name="Containment 연결").click()
    page.locator('#metamodel-workspace-canvas [data-workspace-kind="semantic_type"]').filter(has_text="Worker Pool Inspector").click()
    page.locator('#metamodel-workspace-canvas [data-workspace-kind="semantic_type"]').filter(has_text="Monitoring Agent").dispatch_event("pointerover", {"bubbles": True})
    expect(page.locator("#metamodel-workspace-mode-status")).to_contain_text("Monitoring Agent")
    expect(page.locator("#metamodel-workspace-mode-status")).to_contain_text("새 rule 생성")
    ...
    page.locator('#metamodel-workspace-canvas [data-workspace-kind="semantic_type"]').filter(has_text="Worker Pool Inspector").dispatch_event("pointerover", {"bubbles": True})
    expect(page.locator("#metamodel-workspace-mode-status")).to_contain_text("Worker Pool Inspector")
    expect(page.locator("#metamodel-workspace-mode-status")).to_contain_text("기존 definition 편집")
    page.locator('#metamodel-workspace-canvas [data-workspace-kind="semantic_type"]').filter(has_text="Worker Pool Inspector").click()
    expect(page.locator("#metamodel-association-form-mode")).to_contain_text("edit")
    expect(page.locator("#metamodel-association-display-name")).to_have_value("Monitors Worker Pool Updated")
    ...
    page.locator('#metamodel-workspace-canvas [data-workspace-kind="semantic_type"]').filter(has_text="Monitoring Agent").dispatch_event("pointerover", {"bubbles": True})
    expect(page.locator("#metamodel-workspace-mode-status")).to_contain_text("Monitoring Agent")
    expect(page.locator("#metamodel-workspace-mode-status")).to_contain_text("새 definition 생성")
    page.locator('#metamodel-workspace-canvas [data-workspace-kind="semantic_type"]').filter(has_text="Monitoring Agent").click()
    expect(page.locator("#metamodel-association-form-mode")).to_contain_text("edit")
